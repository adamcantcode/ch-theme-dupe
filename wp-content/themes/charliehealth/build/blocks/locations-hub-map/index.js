...
/*!*******************************************!*\
  ...
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ "./blocks/locations-hub-map/index.css");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  fetch(`${window.location.origin}/wp-json/wp/v2/locations?parent=0&per_page=100&status=publish`).then(res => res.json()).then(posts => {
    ...
    for (const [abbrev, state] of Object.entries(simplemaps_usmap_mapdata.state_specific)) {
    ...
    if (typeof simplemaps_usmap.refresh === 'function') {
      ...
      for (const path of statePaths) {
        ...
        if (match) {
          ...
          path.classList.add(activeStates.has(abbrev) ? 'active-state' : 'inactive-state');
        }
      }
