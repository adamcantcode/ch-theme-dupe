<div class="grid lg:grid-cols-2 lg:gap-[100px] gap-base5-10">
  <div>
    <h5>WHAT WE TREAT</h5>
    <h2>The <mark class="bg-transparent text-referrals-blue-300">core mental health conditions</mark> we treat </h2>
  ...
  <div>
    <h5>WHO WE TREAT</h5>
    <h2>Our <mark class="bg-transparent text-referrals-blue-300">special programming</mark> for specific groups</h2>
