...
<div class="grid grid-cols-1 gap-sp-5 lg:grid-cols-4">
  ...
  <div class="bg-lavender-300 rounded-[6px] p-sp-5 flex flex-col">
    ...
    <div>
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Care deeply</h4>
      ...
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Inspire hope</h4>
  ...
  <div class="bg-pale-blue-200 rounded-[6px] p-sp-5 flex flex-col">
    ...
    <div>
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Stay curious</h4>
      ...
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Heed the evidence</h4>
  ...
  <div class="bg-yellow-300 rounded-[6px] p-sp-5 flex flex-col">
    ...
    <div>
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Act with urgency</h4>
      ...
      <h4 class="font-heading lg:text-[28px] text-[20px] leading-[1.1] mb-sp-2">Don’t give up</h4>
