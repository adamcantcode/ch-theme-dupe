...
/*!*************************************!*\
  ...
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ "./blocks/orbit-image/index.css");
...
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, gsap_MotionPathPlugin__WEBPACK_IMPORTED_MODULE_3__.MotionPathPlugin);

// Step 1: Fade in and scale up #cO and #cM
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(['#cO', '#cM'], {
  duration: 1.5,
  opacity: 0,
  scale: 0,
  stagger: 0.2,
...
function startOrbit() {
  ...
  circles.forEach((circle, index) => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(circle, {
      x: 0,
      y: 0,
      opacity: 0
    });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(circle, {
      duration: 30,
      ease: 'none',
      repeat: -1,
      motionPath: {
        ...
        // Use the adjusted start positions
