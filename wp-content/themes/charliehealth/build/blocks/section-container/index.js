...
window.addEventListener('DOMContentLoaded', () => {
  if (document.querySelector('.bg-circle')) {
    ...
    const beforeRule = gsap_CSSRulePlugin__WEBPACK_IMPORTED_MODULE_2__.CSSRulePlugin.getRule('section.bg-circle::before');
    const bgVideo = document.querySelector('.video-mask-container').parentElement;

    // Create the animation timeline
    let bgElem = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
      scrollTrigger: {
    ...
    let video = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
      scrollTrigger: {
        trigger: 'section.bg-circle',
        start: 'top center',
        // Adjust start position
