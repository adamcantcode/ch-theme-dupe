...
(() => {
/*!******************************************!*\
  !*** ./blocks/alumni-schedules/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('scheduleRendered', () => {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.getAll().forEach(trigger => trigger.kill());
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('#schedule', {
    autoAlpha: 0,
    y: 20
  }, {
    duration: 0.3,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from('.event-cards-js', {
    duration: 0.4,
    y: 20,
    autoAlpha: 0,
    stagger: 0.05,
