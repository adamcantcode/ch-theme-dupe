...
<div class="features-block grid grid-cols-1 gap-sp-14 lg:gap-sp-5 lg:grid-cols-[4fr_1fr_7fr] items-start">
  ...
  <div class="features-block-callout">
    <?= $calloutCopy; ?>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-sp-6 feature-card mt-sp-12">
      ...
      <div class="bg-yellow-300 rounded-[6px] p-sp-5 flex flex-col">
        ...
        <h3 class="mb-[10px] font-heading leading-[1.1]"><?= $features[2]['heading']; ?></h3>
        <p class="mb-0 text-primary text-[14px] leading-[1.4]"><?= $features[2]['subheading']; ?></p>
      </div>
    </div>
  </div>
</div>