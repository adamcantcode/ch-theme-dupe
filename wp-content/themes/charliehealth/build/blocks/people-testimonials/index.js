...
/***/ "./blocks/people-testimonials/index.css":
/*!**********************************************!*\
  !*** ./blocks/people-testimonials/index.css ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*********************************************!*\
  !*** ./blocks/people-testimonials/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ "./blocks/people-testimonials/index.css");
...
window.addEventListener('load', () => {
  ...
  const toggleDropdown = contentWrappperInstance => {
    const toggleButton = contentWrappperInstance.querySelector('.toggle-button-testimonial');
    contentWrappperInstance.style.paddingBottom = toggleButton.clientHeight + 20 + 'px';
    toggleButton.addEventListener('click', e => {
      ...
      if (contentWrappperInstance.style.height) {
        ...
        contentWrappperInstance.style.height = contentWrappperInstance.scrollHeight + 'px';
        toggleButton.remove();
      }
    });
  };
