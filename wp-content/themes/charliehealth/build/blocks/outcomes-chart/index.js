...
!function() {
/*!****************************************!*\
  !*** ./blocks/outcomes-chart/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
...
window.addEventListener('DOMContentLoaded', () => {
  let graphAnimate = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    scrollTrigger: {
  ...
  graphAnimate.from('#graphAnimate .y-labels', {
    opacity: 0,
    duration: '.5',
    translateX: '10px'
  }, '>-0.7');
  graphAnimate.from('#graphAnimate .ch-iop-bar', {
    scaleY: 0,
    opacity: 0,
  ...
  graphAnimate.from('#graphAnimate .avg-iop-bar', {
    scaleY: 0,
    opacity: 0,
    transformOrigin: 'bottom',
    duration: '1',
  ...
  graphAnimate.from('#graphAnimate .x-labels', {
    opacity: 0,
    duration: '.3',
    translateY: '-10px'
  }, '>-.2');
  graphAnimate.from('#graphAnimate .title', {
    opacity: 0,
    duration: '.3',
    translateY: '10px'
  }, '>-0.3');
