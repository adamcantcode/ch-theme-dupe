<div class="rounded-[6px] bg-primary grid lg:grid-cols-[1fr_1fr_1fr_1fr] lg:p-sp-12 p-sp-8 gap-x-sp-10 gap-y-sp-8 lg:gap-y-0 relative hover:bg-primary-200 group transition-all duration-300">
  <div>
  ...
  <div class="grid content-between">
    <div class="order-2 lg:ml-auto lg:order-1 mt-sp-8 lg:mt-0">
    ...
    <h4 class="flex items-center order-1 mb-0 text-white lg:order-2"><a href="https://www.charliehealth.com/intensive-outpatient-iop/outcomes" class="no-underline hover:text-white stretched-link">Explore our Outcomes</a><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-sp-4 group-hover:translate-x-[5px] transition-all duration-300">
