<section class="relative w-screen h-screen overflow-hidden section hero-bg-vid">
  ...
  <div class="relative z-10 flex flex-col items-center justify-center h-full text-center container-md">
    <h1 class="text-white font-heading-serif mb-base5-1">Connecting the world to life-saving</h1>
    <span class="inline-block text-h1-base font-heading-serif mb-base5-10 value-props-js text-lavender-300">behavioral health treatment</span>
