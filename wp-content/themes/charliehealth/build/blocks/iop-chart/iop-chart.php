<div id="mainContainer" class="h-[600px] flex">
  <div id="acuity" class="flex h-full">
    <div class="w-sp-5 bg-[linear-gradient(#fead80,#e2deca_50%,#bdc6fc)]"></div>
    <div class="flex flex-col justify-between">
      <h6 class="mb-0 ml-sp-2">Hight Acuity</h6>
      <h6 class="mb-0 ml-sp-2">Low Acuity</h6>
    </div>
  </div>
  <div id="mainChart" class="flex flex-col items-center w-full">
    <h3 id="crisis" class="mb-sp-4">Mental Health Crisis</h3>
    <div class="flex items-center h-full">
      <div id="symptomsDown" class="flex items-center gap-sp-4">
        ...
        <h5 class="text-center">Improving<br> Symptoms<br> "Step Down"</h5>
      </div>
      <div id="mainGraphic" class="relative w-[600px] h-full">
        ...
        <div id="circleWhite" class="absolute h-1/3 -translate-x-1/2 -translate-y-1/2 bg-white top-1/2 left-1/2 aspect-square rounded-[100%] flex items-center justify-center">
          <h4 id="ch" class="mb-0 font-heading-serif">Charlie<br> Health</h4>
        </div>
        <div id="inpatient" class="absolute text-center -translate-x-1/2 bg-white rounded-sm p-sp-2 top-sp-8 left-1/2">
          <h5 class="mb-0">Inpatient/Residential<br> Treatment</h5>
        </div>
        <div id="outpatient" class="absolute text-center -translate-x-1/2 bg-white rounded-sm p-sp-2 bottom-sp-8 left-1/2">
          <h5 class="mb-0">Outpatient Care</h5>
        </div>
      </div>
      <div id="symptomsUp" class="flex items-center gap-sp-4">
        <h5 class="text-center">Worsening<br> Symptoms<br> "Step Up"</h5>
        <svg xmlns="http://www.w3.org/2000/svg" width="38" height="103" viewBox="0 0 38 103" fill="none">
