...
<section class="section-bg-js bg-grey-warm">
  <div class="section-top pin-section">
    <div class="container pin-container">
      <h2 class="text-center text-h4-base font-heading"><?= $heading; ?></h2>
      <div>
              ...
              <div>
                ...
                <div class="absolute opacity-0 get-started-quote-js">
                  ...
                  <div class="bg-white py-sp-4 px-sp-5 mb-sp-4 rounded-[6px]">
                    <p class="text-h4-base">"<?= $steps[4]['quotes'][0]['quote']; ?>"</p>
                  </div>
                ...
                <div class="absolute opacity-0 get-started-quote-js">
                  ...
                  <div class="bg-white py-sp-4 px-sp-5 mb-sp-4 rounded-[6px]">
                    <p class="text-h4-base">"<?= $steps[4]['quotes'][1]['quote']; ?>"</p>
                  </div>
                ...
                <div class="absolute opacity-0 get-started-quote-js">
                  ...
                  <div class="bg-white py-sp-4 px-sp-5 mb-sp-4 rounded-[6px]">
                    <p class="text-h4-base">"<?= $steps[4]['quotes'][2]['quote']; ?>"</p>
                  </div>
                ...
                <div class="absolute opacity-0 get-started-quote-js">
                  ...
                  <div class="bg-white py-sp-4 px-sp-5 mb-sp-4 rounded-[6px]">
                    <p class="text-h4-base">"<?= $steps[4]['quotes'][3]['quote']; ?>"</p>
                  </div>
                ...
                <div class="absolute opacity-0 get-started-quote-js">
                  ...
                  <div class="bg-white py-sp-4 px-sp-5 mb-sp-4 rounded-[6px]">
                    <p class="text-h4-base">"<?= $steps[4]['quotes'][4]['quote']; ?>"</p>
                  </div>
