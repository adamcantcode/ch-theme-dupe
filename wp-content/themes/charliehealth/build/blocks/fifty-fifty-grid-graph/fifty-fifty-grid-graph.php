    ...
    <div class="grid md:grid-cols-[1fr_2fr_2fr_1fr] gap-sp-5 items-end stats-block-grid-graph-container grid-cols-1">
      ...
      <div class="text-center stats-block-grid-graph">
        ...
        <div class="graph flex flex-col justify-center items-center bg-lavender-300 w-full h-[130px] p-sp-4">
          ...
          <p class="!mb-0 text-center text-primary !leading-[1.1]"><?= $detailsOne; ?></p>
        </div>
      </div>
      <div class="text-center stats-block-grid-graph">
        <span class="counter block text-[56px] text-white leading-[1.1] font-heading-serif mb-sp-4 antialiased"><?= $statTwo; ?>%</span>
        <div class="graph flex flex-col justify-center items-center bg-lavender-100 w-full h-[85px] p-sp-4">
