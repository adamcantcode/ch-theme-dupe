...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="<?= site_url('/wp-content/themes/charliehealth/resources/images/logos/charlie-health_logo-blue-bg.ico'); ?>">
  <link rel="icon" type="image/png" href="<?= site_url('/wp-content/themes/charliehealth/resources/images/logos/charlie-health_logo-blue-bg.png'); ?>">
  <link rel="apple-touch-icon" href="<?= site_url('/wp-content/themes/charliehealth/resources/images/logos/charlie-health_logo-blue-bg.png'); ?>">
...
<body <?php body_class('bg-white ' . $blog); ?>>
  ...
  } elseif ($currentBlog === 4) {
    if (!empty(get_field('get_started', get_the_ID()))) {
      $getStarted = get_field('get_started', get_the_ID());
    } else {
      $getStarted = ['url' => 'https://identity.app.charliehealth.com/u/login', 'target' => '_blank', 'title' => 'Alumni Login'];
    }
    if (!empty(get_field('client_login', get_the_ID()))) {
      $clientLogin = get_field('client_login', get_the_ID());
    } else {
