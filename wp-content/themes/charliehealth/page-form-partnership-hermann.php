<?php
/*
Template Name: Formstack - Partnership Form - Hermann
...
<div class="section">
  <div class="container-sm">
    <script type="text/javascript" src="https://charliehealth-nrkok.formstack.com/forms/js.php/ch_professional_referral_form_copy_6_copy"></script><noscript><a href="https://charliehealth-nrkok.formstack.com/forms/ch_professional_referral_form_copy_6_copy" title="Online Form">Online Form - Charlie Health Professional Referral Form - Memorial Hermann</a></noscript>
    <script>
      ...
      var form = window.fsApi().getForm('6046590');
      ...
      form.registerFormEventListener({
        ...
        onFormEvent: function(event) {
          ...
          const accountIDField = form.getField('178370348'); // Field for RS_Account_ID
          const userJourney = form.getField('178370368')
