<div class="grid justify-between lg:grid-cols-2 gap-sp-5">
  <?php if (have_rows('links')) : ?>
    ...
    ?>
      <div class="relative flex flex-col justify-between bg-white rounded-sm group lg:p-base5-5 p-base5-3">
