<div class="rounded-[6px] bg-primary grid grid-cols-[1fr_1fr_1fr_1fr] p-sp-12 gap-x-sp-10">
  <div>
  ...
  <div class="grid content-between">
    ...
    <h4 class="flex items-center justify-center mb-0 text-white ml-sp-4"><a href="https://www.charliehealth.com/intensive-outpatient-iop/outcomes" class="no-underline hover:text-white">Explore our Outcomes</a><span><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-sp-4">
