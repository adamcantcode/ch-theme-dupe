...
<div class="features-block grid grid-cols-1 lg:gap-sp-5 gap-sp-4 lg:grid-cols-[4fr_1fr_7fr] items-start">
  ...
  <div class="features-block-callout">
    ...
    <div class="grid lg:auto-cols-fr lg:grid-flow-col lg:gap-base5-5 gap-base5-3 lg:mt-base5-6 mt-base5-9">
      <div class="bg-pale-blue-200 rounded-md p-base5-4 flex flex-col feature-card <?php !is_admin() ? 'opacity-0' : ''; ?>">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-base5-5 lg:mb-base5-9">
      ...
      <div class="bg-lavender-300 rounded-md p-base5-4 flex flex-col feature-card <?php !is_admin() ? 'opacity-0' : ''; ?>">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-base5-5 lg:mb-base5-9">
      ...
      <div class="bg-yellow-300 rounded-md p-base5-4 flex flex-col feature-card <?php !is_admin() ? 'opacity-0' : ''; ?>">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-base5-5 lg:mb-base5-9">
