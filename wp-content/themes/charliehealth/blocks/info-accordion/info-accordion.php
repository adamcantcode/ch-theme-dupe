            ...
            <div class="flex justify-between cursor-pointer accordion-header-iop py-base5-4 px-sp-6">
              ...
              <div class="flex items-center ml-sp-5 toggle">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M1 11.0001H22.9984V13.0001H1V11.0001Z" fill="#161A3D" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M10.999 23.0001V1.00171H12.999V23.0001H10.999Z" fill="#161A3D" class="vertical" />
                </svg>
              </div>
            </div>
