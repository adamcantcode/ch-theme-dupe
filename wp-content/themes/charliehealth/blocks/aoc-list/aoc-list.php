<div class="grid grid-cols-[3fr_1fr_8fr] gap-x-sp-5">
  ...
  <div></div>
  <div>
    <div class="overflow-hidden transition-all duration-500 ease-in-out view-all-js max-h-[33vh]">
      <?php
      $args = array(
      ...
      if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
          <a href="<?= get_the_permalink(); ?>" class="stretched-link no-underline pb-sp-6 border-b-2 border-primary grid grid-cols-[3fr_5fr] mb-sp-6 gap-x-sp-5 items-center">
            <div class="flex items-center">
              ...
              <span class="ml-sp-4"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
