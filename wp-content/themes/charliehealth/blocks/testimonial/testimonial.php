...
<section <?= $anchor ?: ''; ?>class="<?= $className . ' ' . $padding ?: '' . ' ' . $margin ?: ''; ?> testimonial-padding bg-cream" style="<?= $style; ?>">
  <h2 class="container">Hear from the Charlie Health Community</h2>
  <div class="swiper swiper-testimonial">
    <div class="container swiper-wrapper">
      <div class="swiper-slide grid grid-cols-[1fr,_2fr]">
        <div class="info">
    ...
    <div class="container relative h-[50px] my-sp-8">
    ...
    <div class="swiper-pagination relative max-w-[1280px] mx-auto"></div>
  </div>
</section>
