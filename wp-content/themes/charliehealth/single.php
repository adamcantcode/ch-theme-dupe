              ...
              <div class="flex flex-col lg:flex-row gap-base5-10 mb-base5-2">
                ...
                <?php if (!empty($medicalReviewer)) : ?>
                  <div class="relative flex items-center">
                    <img src="<?= $medicalReviewerFeaturedImageUrl; ?>" alt="<?= $medicalReviewerFeaturedImageAltText; ?>" class="object-cover w-auto h-base5-10 aspect-square rounded-circle mr-base5-2">
