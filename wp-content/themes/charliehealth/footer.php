				...
				<div class="relative rounded-md container-sm bg-cream !max-w-[950px]">
					...
					<div class="grid lg:grid-cols-[1fr_2fr] items-center lg:h-[500px]">
						<div class="relative h-full">
							<img src="<?= $image['url']; ?>" alt="<?= $image['alt']; ?>" class="object-cover w-full h-full lg:rounded-tl-md lg:rounded-tr-none lg:rounded-bl-md rounded-t-md max-h-[20vh] lg:max-h-none">
