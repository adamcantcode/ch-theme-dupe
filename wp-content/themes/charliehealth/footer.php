<?php if(!get_field('new_navigation_footer')) : ?>
	...
	<div class="section bg-primary">
		<div class="container mb-sp-8">
			<div class="flex gap-x-sp-6">
				<a href="<?= $sublinkUrl; ?>" class="text-white no-underline font-heading text-nav-normal mb-sp-3 last:mb-0 hover:text-lavender-200"><?= $sublinkTitle; ?>asdfasfasdf</a>
