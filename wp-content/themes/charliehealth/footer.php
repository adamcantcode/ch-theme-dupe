...
<footer id="footer" class="grid bg-secondary-soft relatve">
	...
	<div class="section bg-primary">
		...
		<div class="container mb-sp-8">
			<p class="text-[#87889A] text-[12px] leading-snug mb-sp-[12px]">CH MH Services (CA) LLC is certified by the State Department of Health Care Services (Lic. #300414AP expiring 06/30/2025). For detailed information on our <a href="https://geohub-cadhcs.hub.arcgis.com/" target="_blank" class="!text-[#87889A] text-[12px] leading-snug underline">California Facility Licensure, please visit the California Health and Human Services Department’s website.</a></p>
