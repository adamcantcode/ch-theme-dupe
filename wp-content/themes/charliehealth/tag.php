    ...
    <div class="container">
      ...
      <div class="flex items-start overflow-x-scroll gap-sp-4 whitespace-nowrap custom-scroll">
        ...
        foreach ($terms as $term) : ?>
          <a href="<?= $term->slug; ?>" class="no-underline duration-300 rounded-lg px-sp-4 py-sp-3 text-h5 <?= $currentTag === $term->slug ? 'bg-dark-blue text-white' : 'bg-tag-gray hover:bg-bright-teal'; ?>"><?= $term->name; ?></a>
        <?php endforeach; ?>
      </div>
    </div>
  </section>
